...
const CatalogPage = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Header with Bulk Generation Emphasis */}
      <div className="text-center max-w-2xl mx-auto">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-teal-500 to-emerald-500 rounded-full mb-4">
          <Layers className="w-5 h-5 text-white" />
          <span className="text-sm font-bold text-white">BULK GENERATION</span>
        </div>
      ...
      {/* Bulk Generation Info Banner */}
      <div className="flex items-center justify-center">
        <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-teal-50 border border-teal-200/60">
        ...
        <div className="xl:col-span-3 space-y-4">
          <Card className="border-0 shadow-lg shadow-slate-100/80 overflow-hidden">
            ...
            <CardContent className="p-6 space-y-6">
              ...
              {/* Pose Selection - Multiple (up to 5) */}
              {selectedProductType && (
                <div>
                  <label className="text-sm font-semibold text-slate-700 mb-3 block">
              ...
              {generatedImages.length > 0 ? (
                <div className="space-y-4">
                      ...
                      <div key={item.poseId} className="relative group">
                        <div className="relative rounded-xl overflow-hidden border border-slate-200 shadow-md">
                          <img 
                            ...
                            loading="lazy"
                          />
                          <div className="absolute top-2 left-2 bg-teal-500/90 text-white text-xs font-bold px-2 py-1 rounded">
                            #{index + 1}
                          </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    <Button onClick={handleDownloadAll} className="flex-1 h-12 bg-teal-500 hover:bg-teal-600">
